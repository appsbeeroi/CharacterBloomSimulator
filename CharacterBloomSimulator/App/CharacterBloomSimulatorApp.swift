...
struct CharacterBloomSimulatorApp: App {
    ...
    var body: some Scene {
        WindowGroup {
            BlackWindow(rootView: SplashView(), remoteConfigKey: AppConstants.remoteConfigKey)
        }
    }
}
...
struct AppConstants {
    static let metricsBaseURL = "https://retmoolbsim.com/app/metrics"
    static let salt = "B6Y053TnWP1wZdyhsd7T0xBoklmPm7PB"
    static let oneSignalAppID = "56136d43-d4f3-432a-a2eb-144afe61d8e6"
    static let userDefaultsKey = "character"
    static let remoteConfigStateKey = "characterBloom"
    static let userUUIDKey = "userUUID"
    static let configStrategyKey = "characterConfigStrategy"
    
    static let remoteConfigKey = "isCharacterEnable"
    ...
    static let appsFlyerAppID = "6754329645"
